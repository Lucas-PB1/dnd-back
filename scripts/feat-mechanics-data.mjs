...
export const FEAT_MECHANICS = {
  ...
  "weapon-master": {
    hooks: ["weapon_mastery"],
    description: "+1 slot de maestria em armas",
  },
  observant: { hooks: ["expertise"], description: "+1 especialização (Insight/Investigation/Perception)" },
  "keen-mind": { hooks: ["expertise"], description: "+1 especialização (Int/Wis skills)" },
  "skill-expert": { hooks: ["expertise"], description: "+1 especialização" },
  ...
  "shield-master": { hooks: ["asi", "general_progression", "passive"], description: "ASI For + escudo" },
  ...
  poisoner: { hooks: ["asi", "general_progression", "passive"], description: "ASI Des/Int + veneno" },
  actor: { hooks: ["asi", "general_progression", "passive"], description: "ASI Car + disfarce" },
  chef: { hooks: ["asi", "general_progression", "passive"], description: "ASI Con/Sab + cozinha" },
  ...
  healer: { hooks: ["passive"], description: "Kit + cura por dado de vida" },
