/**
 * Gera seeds do lote §0 #1 (poção / óleo / pergaminho).
 * Uso: node scripts/generate-dmg-consumable-lote.mjs
 */
import fs from 'fs';
...
const jsonPath = path.join(sourceDir, 'dmg-2024-itens-magicos-az.json');
