...
export function buildSpellSources() {
  const sources = [
    ...
    { id: "spellbook", label: "Livro de Magias", originType: "class_list" },
    { id: "magic-initiate", label: "Iniciado em Magia", originType: "feat", featId: "magic-initiate" },
    { id: "fey-touched", label: "Tocado pelas Fadas", originType: "feat", featId: "fey-touched" },
    { id: "shadow-touched", label: "Tocado pela Sombra", originType: "feat", featId: "shadow-touched" },
    { id: "telekinetic", label: "Telecinético", originType: "feat", featId: "telekinetic" },
    { id: "telepathic", label: "Telepático", originType: "feat", featId: "telepathic" },
    { id: "ritual-caster", label: "Conjurador Ritualista", originType: "feat", featId: "ritual-caster" },
