...
const REPLACEMENTS = [
  ...
  ['Blackpowder Pistol', 'Pistola de Pólvora Negra'],
  ['Blackpowder Pistols', 'Pistolas de Pólvora Negra'],
  ['Shadowsteel Focus', 'Foco de Shadowsteel'],
  ['Shadowsteel curses', 'maldições de Shadowsteel'],
  ['Shadowsteel curse', 'maldição de Shadowsteel'],
  ['Advanced weapons', 'armas Avançadas'],
  ['Advanced weapon', 'arma Avançada'],
  ['Grim Hollow Campaign Guide', 'Grim Hollow: Guia de Campanha'],
  ['Arcanist Inquisition', 'Inquisição Arcanista'],
  ['Ebon Syndicate', 'Sindicato de Ébano'],
  ['Thaumaturge', 'Taumaturgo'],
  ['Company of Free Swords', 'Companhia das Espadas Livres'],
  ['Augustine Trading Company', 'Companhia de Comércio Augustine'],
  ['Morbus Doctore', 'Morbus Doctore'],
