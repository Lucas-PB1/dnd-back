...
VALUES
  ...
  ('barding-padded', 'other'::rpg.item_type, 'Barding — Acolchoada', '{"text":"20 PO"}'::jsonb, '8 kg', 'Armadura feita para montaria. Qualquer armadura da tabela do PHB pode ser comprada como barding; custo ×4 e peso ×2 da armadura equivalente.', '{"kind":"barding","baseArmorSlug":"padded"}'::jsonb),
  ('barding-leather', 'other'::rpg.item_type, 'Barding — Couro', '{"text":"40 PO"}'::jsonb, '10 kg', 'Armadura feita para montaria. Qualquer armadura da tabela do PHB pode ser comprada como barding; custo ×4 e peso ×2 da armadura equivalente.', '{"kind":"barding","baseArmorSlug":"leather"}'::jsonb),
  ('barding-studded-leather', 'other'::rpg.item_type, 'Barding — Couro Batido', '{"text":"180 PO"}'::jsonb, '13 kg', 'Armadura feita para montaria. Qualquer armadura da tabela do PHB pode ser comprada como barding; custo ×4 e peso ×2 da armadura equivalente.', '{"kind":"barding","baseArmorSlug":"studded-leather"}'::jsonb),
  ('barding-hide', 'other'::rpg.item_type, 'Barding — Gibão de Peles', '{"text":"40 PO"}'::jsonb, '12 kg', 'Armadura feita para montaria. Qualquer armadura da tabela do PHB pode ser comprada como barding; custo ×4 e peso ×2 da armadura equivalente.', '{"kind":"barding","baseArmorSlug":"hide"}'::jsonb),
  ('barding-chain-shirt', 'other'::rpg.item_type, 'Barding — Cota de Malha Parcial', '{"text":"200 PO"}'::jsonb, '20 kg', 'Armadura feita para montaria. Qualquer armadura da tabela do PHB pode ser comprada como barding; custo ×4 e peso ×2 da armadura equivalente.', '{"kind":"barding","baseArmorSlug":"chain-shirt"}'::jsonb),
  ('barding-scale-mail', 'other'::rpg.item_type, 'Barding — Loriga de Escamas', '{"text":"200 PO"}'::jsonb, '44 kg', 'Armadura feita para montaria. Qualquer armadura da tabela do PHB pode ser comprada como barding; custo ×4 e peso ×2 da armadura equivalente.', '{"kind":"barding","baseArmorSlug":"scale-mail"}'::jsonb),
  ('barding-breastplate', 'other'::rpg.item_type, 'Barding — Couraça', '{"text":"1.600 PO"}'::jsonb, '20 kg', 'Armadura feita para montaria. Qualquer armadura da tabela do PHB pode ser comprada como barding; custo ×4 e peso ×2 da armadura equivalente.', '{"kind":"barding","baseArmorSlug":"breastplate"}'::jsonb),
  ('barding-half-plate', 'other'::rpg.item_type, 'Barding — Meia-Placa', '{"text":"3.000 PO"}'::jsonb, '40 kg', 'Armadura feita para montaria. Qualquer armadura da tabela do PHB pode ser comprada como barding; custo ×4 e peso ×2 da armadura equivalente.', '{"kind":"barding","baseArmorSlug":"half-plate"}'::jsonb),
  ('barding-ring-mail', 'other'::rpg.item_type, 'Barding — Cota de Anéis', '{"text":"120 PO"}'::jsonb, '40 kg', 'Armadura feita para montaria. Qualquer armadura da tabela do PHB pode ser comprada como barding; custo ×4 e peso ×2 da armadura equivalente.', '{"kind":"barding","baseArmorSlug":"ring-mail"}'::jsonb),
  ('barding-chain-mail', 'other'::rpg.item_type, 'Barding — Cota de Malha', '{"text":"300 PO"}'::jsonb, '54 kg', 'Armadura feita para montaria. Qualquer armadura da tabela do PHB pode ser comprada como barding; custo ×4 e peso ×2 da armadura equivalente.', '{"kind":"barding","baseArmorSlug":"chain-mail"}'::jsonb),
  ('barding-splint', 'other'::rpg.item_type, 'Barding — Armadura de Talas', '{"text":"800 PO"}'::jsonb, '60 kg', 'Armadura feita para montaria. Qualquer armadura da tabela do PHB pode ser comprada como barding; custo ×4 e peso ×2 da armadura equivalente.', '{"kind":"barding","baseArmorSlug":"splint"}'::jsonb),
  ('barding-plate', 'other'::rpg.item_type, 'Barding — Placas', '{"text":"6.000 PO"}'::jsonb, '64 kg', 'Armadura feita para montaria. Qualquer armadura da tabela do PHB pode ser comprada como barding; custo ×4 e peso ×2 da armadura equivalente.', '{"kind":"barding","baseArmorSlug":"plate"}'::jsonb),
...
pessoa (CD 15) ou duplicar um selo de cera (CD 20)', '{"attribute":"Destreza","crafting":null,"variants":null}'::jsonb),
  ...
  ('navio-a-remo', 'other'::rpg.item_type, 'Navio a Remo', '{"text":"30.000 PO"}'::jsonb, '—', 'Veículo grande.', '{"kind":"large-vehicle","speed":"4 mph","crew":80,"cargoTons":150,"ac":15,"hp":500,"damageThreshold":20}'::jsonb),
