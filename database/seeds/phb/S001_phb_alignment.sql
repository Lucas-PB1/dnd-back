-- Seed rpg.phb_alignment
-- Gerado automaticamente — não editar à mão

INSERT INTO rpg.phb_alignment (slug, name, abbreviation, description)
VALUES
  ('lawful-good', 'Leal e Bom', 'LB', 'Criaturas Leais e Boas se esforçam para fazer a coisa certa, conforme esperado pela sociedade.'),
  ...
  ('lawful-neutral', 'Leal e Neutro', 'LN', 'Indivíduos Leais e Neutros agem de acordo com a lei, tradição ou códigos pessoais.'),
  ...
  ('lawful-evil', 'Leal e Mau', 'LM', 'Criaturas Leais e Más tomam metodicamente o que querem dentro dos limites de um código de tradição, lealdade ou ordem.'),
