...
('fighter-blood-strike', (SELECT id FROM rpg.phb_class WHERE slug = 'fighter'), (SELECT id FROM rpg.phb_subclass WHERE slug = 'blood-hound'), 'Golpe de Sangue', 'free'::rpg.action_economy_bucket, 3, 'blood-strike', NULL, false, '1×/turno: opção de Golpe (custo de sangue)', 'Aplica uma opção de Golpe de Sangue a um ataque; sofre o Custo de Sangue. Pool na Economia.', 'blood-strike', NULL, 100),
