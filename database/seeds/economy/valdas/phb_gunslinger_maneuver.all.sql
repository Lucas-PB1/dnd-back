...
VALUES
  ...
  ('blindfire', 'Fogo cego', 'Ação Bônus: gaste um Dado de Risco para ganhar Visão Cega de 9 m até o fim do turno.', 'blindsense_until_eot', 1, 2, NULL),
  ...
  ('showdown', 'Confronto', 'Na Iniciativa (Pistolero): gaste 1 Dado de Risco, saque uma arma à distância e ataque; some o dado ao dano. No 1º turno, o alvo tem Desvantagem em ataques contra outros.', 'attack_damage_bonus', 1, 10, (SELECT id FROM rpg.phb_subclass WHERE slug = 'pistolero')),
