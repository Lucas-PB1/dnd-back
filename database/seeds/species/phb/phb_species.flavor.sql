-- Flavor de espécies (tagline/summary) — idempotente após S041
...
FROM (VALUES
  ...
  ('dragonborn', 'Herdeiros dos dragões', 'Escamas, sopro elemental e herança dos ovos dracônicos.'),
  ...
  ('tiefling', 'Ancestralidade dos Planos Inferiores', 'Poder ínfero no sangue, sem ditar o caráter moral.')
