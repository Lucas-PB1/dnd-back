...
WHERE e.owner_kind = 'feat'
  AND e.owner_id = f.id
  AND f.slug IN (
    'brewer', 'fisher', 'northern-raider', 'norn-touched',
    'well-versed', 'cold-plunge-training', 'sea-wolf', 'snowrunner'
  );
...
WHERE e.owner_kind = 'feat'
  AND e.owner_id = f.id
  AND f.slug IN (
    'axe-fighter', 'axe-thrower', 'battle-cry', 'blessing-of-angrboda-and-bergelmir',
    'blessing-of-bragi', 'blessing-of-heimdall', 'blessing-of-hel', 'blessing-of-njord',
    'blessing-of-skadi', 'blessing-of-the-snow-queen', 'blessing-of-tyr',
    'blood-of-the-berserker', 'bloodied-resilience', 'bloody-resolve', 'boisterous-roar',
    'brazen-courage', 'chosen-by-fate', 'clout', 'cold-water-warrior', 'combat-flyting',
    'cut-down-the-nithingr', 'endurance-conditioning', 'faster-crafting', 'fjord-jumper',
    'frost-eyed', 'frost-touched', 'giant-slayer', 'greater-blessing-of-baldur',
    'greater-blessing-of-boreas', 'greater-blessing-of-freyr-and-freyja',
    'greater-blessing-of-jormungandr', 'greater-blessing-of-loki', 'greater-blessing-of-sif',
    'greater-blessing-of-thor', 'greater-blessing-of-wotan', 'heroic-rush', 'holmganga-master',
    'hunter', 'ice-mastery', 'lightning-mastery', 'living-off-the-land', 'long-haft-strike',
    'moon-touched', 'mounted-leap', 'northlands-hardiness', 'primal', 'ravens-friend',
    'spear-expert', 'surtrs-touch', 'tricksters-toolbox', 'wild-lore'
  );
...
WHERE e.owner_kind = 'feat'
  AND e.owner_id = f.id
  AND f.slug IN (
    'glima', 'raiders-rush', 'savagery', 'shield-wall', 'skirmisher', 'underfoot'
  );
