...
ON CONFLICT (class_id, level) DO UPDATE SET proficiency_bonus = EXCLUDED.proficiency_bonus, cantrips = EXCLUDED.cantrips, prepared_spells = EXCLUDED.prepared_spells, channel_divinity = EXCLUDED.channel_divinity;
