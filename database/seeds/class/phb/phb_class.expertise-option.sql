...
-- value_type = skill: escolha livre entre perícias proficientes (whitelist opcional via option_value).
...
-- Whitelist acadêmica do Mago (Sábio). Sem option_value = qualquer perícia proficiente.
