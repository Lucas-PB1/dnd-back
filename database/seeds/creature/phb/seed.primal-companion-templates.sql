...
INSERT INTO rpg.phb_creature_scale_by_level (template_slug, hp_base, hp_per_level, ac_ability_slug) VALUES
  ('primal-companion-guardian-land', 8, 5, 'sabedoria'),
  ('primal-companion-guardian-sea', 8, 5, 'sabedoria'),
  ('primal-companion-guardian-sky', 8, 5, 'sabedoria'),
  ('primal-companion-striker-land', 6, 5, 'sabedoria'),
  ('primal-companion-striker-sea', 6, 5, 'sabedoria'),
  ('primal-companion-striker-sky', 6, 5, 'sabedoria')
