...
INSERT INTO rpg.phb_subclass_prepared_spell (subclass_id, unlock_level, spell_id, terrain)
             SELECT s.id, 3, sp.id, 'arid'::rpg.druid_land_terrain FROM rpg.phb_subclass s, rpg.phb_spell sp WHERE s.slug = 'land' AND sp.slug = 'maos-flamejantes'
             ON CONFLICT ON CONSTRAINT uq_subclass_prepared_spell DO NOTHING;

INSERT INTO rpg.phb_subclass_prepared_spell (subclass_id, unlock_level, spell_id, terrain)
             SELECT s.id, 3, sp.id, 'arid'::rpg.druid_land_terrain FROM rpg.phb_subclass s, rpg.phb_spell sp WHERE s.slug = 'land' AND sp.slug = 'turvar'
             ON CONFLICT ON CONSTRAINT uq_subclass_prepared_spell DO NOTHING;

INSERT INTO rpg.phb_subclass_prepared_spell (subclass_id, unlock_level, spell_id, terrain)
             SELECT s.id, 3, sp.id, 'arid'::rpg.druid_land_terrain FROM rpg.phb_subclass s, rpg.phb_spell sp WHERE s.slug = 'land' AND sp.slug = 'raio-de-fogo'
             ON CONFLICT ON CONSTRAINT uq_subclass_prepared_spell DO NOTHING;

INSERT INTO rpg.phb_subclass_prepared_spell (subclass_id, unlock_level, spell_id, terrain)
             SELECT s.id, 5, sp.id, 'arid'::rpg.druid_land_terrain FROM rpg.phb_subclass s, rpg.phb_spell sp WHERE s.slug = 'land' AND sp.slug = 'bola-de-fogo'
             ON CONFLICT ON CONSTRAINT uq_subclass_prepared_spell DO NOTHING;

INSERT INTO rpg.phb_subclass_prepared_spell (subclass_id, unlock_level, spell_id, terrain)
             SELECT s.id, 5, sp.id, 'arid'::rpg.druid_land_terrain FROM rpg.phb_subclass s, rpg.phb_spell sp WHERE s.slug = 'land' AND sp.slug = 'muralha-de-fogo'
             ON CONFLICT ON CONSTRAINT uq_subclass_prepared_spell DO NOTHING;

INSERT INTO rpg.phb_subclass_prepared_spell (subclass_id, unlock_level, spell_id, terrain)
             SELECT s.id, 7, sp.id, 'arid'::rpg.druid_land_terrain FROM rpg.phb_subclass s, rpg.phb_spell sp WHERE s.slug = 'land' AND sp.slug = 'malogro'
             ON CONFLICT ON CONSTRAINT uq_subclass_prepared_spell DO NOTHING;

INSERT INTO rpg.phb_subclass_prepared_spell (subclass_id, unlock_level, spell_id, terrain)
             SELECT s.id, 7, sp.id, 'arid'::rpg.druid_land_terrain FROM rpg.phb_subclass s, rpg.phb_spell sp WHERE s.slug = 'land' AND sp.slug = 'muralha-de-pedra'
             ON CONFLICT ON CONSTRAINT uq_subclass_prepared_spell DO NOTHING;

INSERT INTO rpg.phb_subclass_prepared_spell (subclass_id, unlock_level, spell_id, terrain)
             SELECT s.id, 9, sp.id, 'arid'::rpg.druid_land_terrain FROM rpg.phb_subclass s, rpg.phb_spell sp WHERE s.slug = 'land' AND sp.slug = 'coluna-de-chamas'
             ON CONFLICT ON CONSTRAINT uq_subclass_prepared_spell DO NOTHING;

INSERT INTO rpg.phb_subclass_prepared_spell (subclass_id, unlock_level, spell_id, terrain)
             SELECT s.id, 9, sp.id, 'arid'::rpg.druid_land_terrain FROM rpg.phb_subclass s, rpg.phb_spell sp WHERE s.slug = 'land' AND sp.slug = 'videncia'
             ON CONFLICT ON CONSTRAINT uq_subclass_prepared_spell DO NOTHING;

INSERT INTO rpg.phb_subclass_prepared_spell (subclass_id, unlock_level, spell_id, terrain)
             SELECT s.id, 3, sp.id, 'polar'::rpg.druid_land_terrain FROM rpg.phb_subclass s, rpg.phb_spell sp WHERE s.slug = 'land' AND sp.slug = 'nevoa-obscurecente'
             ON CONFLICT ON CONSTRAINT uq_subclass_prepared_spell DO NOTHING;

INSERT INTO rpg.phb_subclass_prepared_spell (subclass_id, unlock_level, spell_id, terrain)
             SELECT s.id, 3, sp.id, 'polar'::rpg.druid_land_terrain FROM rpg.phb_subclass s, rpg.phb_spell sp WHERE s.slug = 'land' AND sp.slug = 'paralisar-pessoa'
             ON CONFLICT ON CONSTRAINT uq_subclass_prepared_spell DO NOTHING;

INSERT INTO rpg.phb_subclass_prepared_spell (subclass_id, unlock_level, spell_id, terrain)
             SELECT s.id, 3, sp.id, 'polar'::rpg.druid_land_terrain FROM rpg.phb_subclass s, rpg.phb_spell sp WHERE s.slug = 'land' AND sp.slug = 'raio-de-gelo'
             ON CONFLICT ON CONSTRAINT uq_subclass_prepared_spell DO NOTHING;

INSERT INTO rpg.phb_subclass_prepared_spell (subclass_id, unlock_level, spell_id, terrain)
             SELECT s.id, 5, sp.id, 'polar'::rpg.druid_land_terrain FROM rpg.phb_subclass s, rpg.phb_spell sp WHERE s.slug = 'land' AND sp.slug = 'nevasca'
             ON CONFLICT ON CONSTRAINT uq_subclass_prepared_spell DO NOTHING;

INSERT INTO rpg.phb_subclass_prepared_spell (subclass_id, unlock_level, spell_id, terrain)
             SELECT s.id, 5, sp.id, 'polar'::rpg.druid_land_terrain FROM rpg.phb_subclass s, rpg.phb_spell sp WHERE s.slug = 'land' AND sp.slug = 'lentidao'
             ON CONFLICT ON CONSTRAINT uq_subclass_prepared_spell DO NOTHING;

INSERT INTO rpg.phb_subclass_prepared_spell (subclass_id, unlock_level, spell_id, terrain)
             SELECT s.id, 7, sp.id, 'polar'::rpg.druid_land_terrain FROM rpg.phb_subclass s, rpg.phb_spell sp WHERE s.slug = 'land' AND sp.slug = 'cone-de-frio'
             ON CONFLICT ON CONSTRAINT uq_subclass_prepared_spell DO NOTHING;

INSERT INTO rpg.phb_subclass_prepared_spell (subclass_id, unlock_level, spell_id, terrain)
             SELECT s.id, 7, sp.id, 'polar'::rpg.druid_land_terrain FROM rpg.phb_subclass s, rpg.phb_spell sp WHERE s.slug = 'land' AND sp.slug = 'tempestade-glacial'
             ON CONFLICT ON CONSTRAINT uq_subclass_prepared_spell DO NOTHING;

INSERT INTO rpg.phb_subclass_prepared_spell (subclass_id, unlock_level, spell_id, terrain)
             SELECT s.id, 9, sp.id, 'polar'::rpg.druid_land_terrain FROM rpg.phb_subclass s, rpg.phb_spell sp WHERE s.slug = 'land' AND sp.slug = 'comunhao-com-a-natureza'
             ON CONFLICT ON CONSTRAINT uq_subclass_prepared_spell DO NOTHING;

INSERT INTO rpg.phb_subclass_prepared_spell (subclass_id, unlock_level, spell_id, terrain)
             SELECT s.id, 9, sp.id, 'polar'::rpg.druid_land_terrain FROM rpg.phb_subclass s, rpg.phb_spell sp WHERE s.slug = 'land' AND sp.slug = 'passo-arboreo'
             ON CONFLICT ON CONSTRAINT uq_subclass_prepared_spell DO NOTHING;

INSERT INTO rpg.phb_subclass_prepared_spell (subclass_id, unlock_level, spell_id, terrain)
             SELECT s.id, 3, sp.id, 'temperate'::rpg.druid_land_terrain FROM rpg.phb_subclass s, rpg.phb_spell sp WHERE s.slug = 'land' AND sp.slug = 'passo-nebuloso'
             ON CONFLICT ON CONSTRAINT uq_subclass_prepared_spell DO NOTHING;

INSERT INTO rpg.phb_subclass_prepared_spell (subclass_id, unlock_level, spell_id, terrain)
             SELECT s.id, 3, sp.id, 'temperate'::rpg.druid_land_terrain FROM rpg.phb_subclass s, rpg.phb_spell sp WHERE s.slug = 'land' AND sp.slug = 'toque-chocante'
             ON CONFLICT ON CONSTRAINT uq_subclass_prepared_spell DO NOTHING;

INSERT INTO rpg.phb_subclass_prepared_spell (subclass_id, unlock_level, spell_id, terrain)
             SELECT s.id, 3, sp.id, 'temperate'::rpg.druid_land_terrain FROM rpg.phb_subclass s, rpg.phb_spell sp WHERE s.slug = 'land' AND sp.slug = 'sono'
             ON CONFLICT ON CONSTRAINT uq_subclass_prepared_spell DO NOTHING;

INSERT INTO rpg.phb_subclass_prepared_spell (subclass_id, unlock_level, spell_id, terrain)
             SELECT s.id, 5, sp.id, 'temperate'::rpg.druid_land_terrain FROM rpg.phb_subclass s, rpg.phb_spell sp WHERE s.slug = 'land' AND sp.slug = 'relampago'
             ON CONFLICT ON CONSTRAINT uq_subclass_prepared_spell DO NOTHING;

INSERT INTO rpg.phb_subclass_prepared_spell (subclass_id, unlock_level, spell_id, terrain)
             SELECT s.id, 5, sp.id, 'temperate'::rpg.druid_land_terrain FROM rpg.phb_subclass s, rpg.phb_spell sp WHERE s.slug = 'land' AND sp.slug = 'crescimento-de-plantas'
             ON CONFLICT ON CONSTRAINT uq_subclass_prepared_spell DO NOTHING;

INSERT INTO rpg.phb_subclass_prepared_spell (subclass_id, unlock_level, spell_id, terrain)
             SELECT s.id, 7, sp.id, 'temperate'::rpg.druid_land_terrain FROM rpg.phb_subclass s, rpg.phb_spell sp WHERE s.slug = 'land' AND sp.slug = 'movimentacao-livre'
             ON CONFLICT ON CONSTRAINT uq_subclass_prepared_spell DO NOTHING;

INSERT INTO rpg.phb_subclass_prepared_spell (subclass_id, unlock_level, spell_id, terrain)
             SELECT s.id, 7, sp.id, 'temperate'::rpg.druid_land_terrain FROM rpg.phb_subclass s, rpg.phb_spell sp WHERE s.slug = 'land' AND sp.slug = 'moldar-rochas'
             ON CONFLICT ON CONSTRAINT uq_subclass_prepared_spell DO NOTHING;

INSERT INTO rpg.phb_subclass_prepared_spell (subclass_id, unlock_level, spell_id, terrain)
             SELECT s.id, 9, sp.id, 'temperate'::rpg.druid_land_terrain FROM rpg.phb_subclass s, rpg.phb_spell sp WHERE s.slug = 'land' AND sp.slug = 'comunhao-com-a-natureza'
             ON CONFLICT ON CONSTRAINT uq_subclass_prepared_spell DO NOTHING;

INSERT INTO rpg.phb_subclass_prepared_spell (subclass_id, unlock_level, spell_id, terrain)
             SELECT s.id, 9, sp.id, 'temperate'::rpg.druid_land_terrain FROM rpg.phb_subclass s, rpg.phb_spell sp WHERE s.slug = 'land' AND sp.slug = 'muralha-de-pedra'
             ON CONFLICT ON CONSTRAINT uq_subclass_prepared_spell DO NOTHING;

INSERT INTO rpg.phb_subclass_prepared_spell (subclass_id, unlock_level, spell_id, terrain)
             SELECT s.id, 3, sp.id, 'tropical'::rpg.druid_land_terrain FROM rpg.phb_subclass s, rpg.phb_spell sp WHERE s.slug = 'land' AND sp.slug = 'bolha-acida'
             ON CONFLICT ON CONSTRAINT uq_subclass_prepared_spell DO NOTHING;

INSERT INTO rpg.phb_subclass_prepared_spell (subclass_id, unlock_level, spell_id, terrain)
             SELECT s.id, 3, sp.id, 'tropical'::rpg.druid_land_terrain FROM rpg.phb_subclass s, rpg.phb_spell sp WHERE s.slug = 'land' AND sp.slug = 'rajada-de-veneno'
             ON CONFLICT ON CONSTRAINT uq_subclass_prepared_spell DO NOTHING;

INSERT INTO rpg.phb_subclass_prepared_spell (subclass_id, unlock_level, spell_id, terrain)
             SELECT s.id, 3, sp.id, 'tropical'::rpg.druid_land_terrain FROM rpg.phb_subclass s, rpg.phb_spell sp WHERE s.slug = 'land' AND sp.slug = 'teia'
             ON CONFLICT ON CONSTRAINT uq_subclass_prepared_spell DO NOTHING;

INSERT INTO rpg.phb_subclass_prepared_spell (subclass_id, unlock_level, spell_id, terrain)
             SELECT s.id, 5, sp.id, 'tropical'::rpg.druid_land_terrain FROM rpg.phb_subclass s, rpg.phb_spell sp WHERE s.slug = 'land' AND sp.slug = 'nuvem-fetida'
             ON CONFLICT ON CONSTRAINT uq_subclass_prepared_spell DO NOTHING;

INSERT INTO rpg.phb_subclass_prepared_spell (subclass_id, unlock_level, spell_id, terrain)
             SELECT s.id, 5, sp.id, 'tropical'::rpg.druid_land_terrain FROM rpg.phb_subclass s, rpg.phb_spell sp WHERE s.slug = 'land' AND sp.slug = 'polimorfia'
             ON CONFLICT ON CONSTRAINT uq_subclass_prepared_spell DO NOTHING;

INSERT INTO rpg.phb_subclass_prepared_spell (subclass_id, unlock_level, spell_id, terrain)
             SELECT s.id, 7, sp.id, 'tropical'::rpg.druid_land_terrain FROM rpg.phb_subclass s, rpg.phb_spell sp WHERE s.slug = 'land' AND sp.slug = 'praga-de-insetos'
             ON CONFLICT ON CONSTRAINT uq_subclass_prepared_spell DO NOTHING;

INSERT INTO rpg.phb_subclass_prepared_spell (subclass_id, unlock_level, spell_id, terrain)
             SELECT s.id, 7, sp.id, 'tropical'::rpg.druid_land_terrain FROM rpg.phb_subclass s, rpg.phb_spell sp WHERE s.slug = 'land' AND sp.slug = 'muralha-de-espinhos'
             ON CONFLICT ON CONSTRAINT uq_subclass_prepared_spell DO NOTHING;

INSERT INTO rpg.phb_subclass_prepared_spell (subclass_id, unlock_level, spell_id, terrain)
             SELECT s.id, 9, sp.id, 'tropical'::rpg.druid_land_terrain FROM rpg.phb_subclass s, rpg.phb_spell sp WHERE s.slug = 'land' AND sp.slug = 'nevoa-mortal'
             ON CONFLICT ON CONSTRAINT uq_subclass_prepared_spell DO NOTHING;

INSERT INTO rpg.phb_subclass_prepared_spell (subclass_id, unlock_level, spell_id, terrain)
             SELECT s.id, 9, sp.id, 'tropical'::rpg.druid_land_terrain FROM rpg.phb_subclass s, rpg.phb_spell sp WHERE s.slug = 'land' AND sp.slug = 'passo-arboreo'
             ON CONFLICT ON CONSTRAINT uq_subclass_prepared_spell DO NOTHING;
