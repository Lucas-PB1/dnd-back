-- View rpg.v_phb_species_trait_choices (baseline canônico)
...
FROM rpg.phb_species_trait t
JOIN rpg.phb_species sp ON sp.id = t.species_id
JOIN rpg.phb_geppettin_construction gc ON t.choice_kind = 'geppettin_construction'::rpg.species_choice_kind
UNION ALL
SELECT
  sp.slug,
  t.name,
...
FROM rpg.phb_species_trait t
JOIN rpg.phb_species sp ON sp.id = t.species_id
JOIN rpg.phb_mandrake_season ms ON t.choice_kind = 'mandrake_season'::rpg.species_choice_kind
UNION ALL
SELECT
  sp.slug,
  t.name,
