-- Reaplica v_phb_species_trait_choices com escolhas Manikin/Scourgeborne (Eldritch Hunt).
-- Definição canônica permanece em V017; este arquivo reaplica em DBs já migrados.
