-- View rpg.v_phb_species_trait_choices — extensão Northlands (choice_kinds novos)
-- Substitui V017; mantém todos os unions anteriores + Bearfolk/Beastkin/Giantkin/Trollkin.
