-- Inclui heranças Grim Hollow (8 traços modulares + opcionais) em v_phb_species_trait_choices
...
UNION ALL
-- GH heritage modular traits (gh_heritage_trait_1)
SELECT
  sp.slug AS species_slug,
  t.name AS trait_name,
  t.choice_kind,
...
FROM rpg.phb_species_trait t
JOIN rpg.phb_species sp ON sp.id = t.species_id
JOIN rpg.phb_species pool ON pool.slug = 'gh-heritage-traits'
...
WHERE sp.slug LIKE 'gh-%'
  AND sp.slug <> 'gh-heritage-traits'
  AND t.choice_kind = 'gh_heritage_trait_1'::rpg.species_choice_kind
UNION ALL
-- GH heritage modular traits (gh_heritage_trait_2)
SELECT
  sp.slug AS species_slug,
  t.name AS trait_name,
  t.choice_kind,
...
WHERE sp.slug LIKE 'gh-%'
  AND sp.slug <> 'gh-heritage-traits'
  AND t.choice_kind = 'gh_heritage_trait_2'::rpg.species_choice_kind
UNION ALL
-- GH heritage modular traits (gh_heritage_trait_3)
SELECT
  sp.slug AS species_slug,
  t.name AS trait_name,
  t.choice_kind,
...
WHERE sp.slug LIKE 'gh-%'
  AND sp.slug <> 'gh-heritage-traits'
  AND t.choice_kind = 'gh_heritage_trait_3'::rpg.species_choice_kind
UNION ALL
-- GH heritage modular traits (gh_heritage_trait_4)
SELECT
  sp.slug AS species_slug,
  t.name AS trait_name,
  t.choice_kind,
...
WHERE sp.slug LIKE 'gh-%'
  AND sp.slug <> 'gh-heritage-traits'
  AND t.choice_kind = 'gh_heritage_trait_4'::rpg.species_choice_kind
UNION ALL
-- GH heritage modular traits (gh_heritage_trait_5)
SELECT
  sp.slug AS species_slug,
  t.name AS trait_name,
  t.choice_kind,
...
WHERE sp.slug LIKE 'gh-%'
  AND sp.slug <> 'gh-heritage-traits'
  AND t.choice_kind = 'gh_heritage_trait_5'::rpg.species_choice_kind
UNION ALL
-- GH heritage modular traits (gh_heritage_trait_6)
SELECT
  sp.slug AS species_slug,
  t.name AS trait_name,
  t.choice_kind,
...
WHERE sp.slug LIKE 'gh-%'
  AND sp.slug <> 'gh-heritage-traits'
  AND t.choice_kind = 'gh_heritage_trait_6'::rpg.species_choice_kind
UNION ALL
-- GH heritage modular traits (gh_heritage_trait_7)
SELECT
  sp.slug AS species_slug,
  t.name AS trait_name,
  t.choice_kind,
...
WHERE sp.slug LIKE 'gh-%'
  AND sp.slug <> 'gh-heritage-traits'
  AND t.choice_kind = 'gh_heritage_trait_7'::rpg.species_choice_kind
UNION ALL
-- GH heritage modular traits (gh_heritage_trait_8)
SELECT
  sp.slug AS species_slug,
  t.name AS trait_name,
  t.choice_kind,
...
WHERE sp.slug LIKE 'gh-%'
  AND sp.slug <> 'gh-heritage-traits'
  AND t.choice_kind = 'gh_heritage_trait_8'::rpg.species_choice_kind
UNION ALL
-- GH heritage modular traits (gh_heritage_trait_9)
SELECT
  sp.slug AS species_slug,
  t.name AS trait_name,
  t.choice_kind,
...
WHERE sp.slug LIKE 'gh-%'
  AND sp.slug <> 'gh-heritage-traits'
  AND t.choice_kind = 'gh_heritage_trait_9'::rpg.species_choice_kind
UNION ALL
