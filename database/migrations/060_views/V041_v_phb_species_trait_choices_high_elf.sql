-- Inclui opções opcionais de truque do Alto Elfo em trait-choices.
-- high_elf_cantrip NÃO é requiredKinds (filtrado no validator OPTIONAL_KINDS).
...
UNION ALL
-- Truques swappable do Alto Elfo (opcional; só quando lineage = high-elf na UI)
SELECT
