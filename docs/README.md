...
| [`architecture/adr-read-model-layers.md`](architecture/adr-read-model-layers.md) | ADR — view vs MV vs RPC JSONB (Aceito) |
| [`plans/read-model-inventory.md`](plans/read-model-inventory.md) | **Lista objetiva** — tabela / view / MV / RPC |
