...
Overlap: texto “mapa legado” também em [`legado-4-session-docs.md`](legado-4-session-docs.md) / [`pve-10b`](pve-10b-legado-dod.md) — **um PR** pode fechar os dois checklists; não duplicar trabalho.
