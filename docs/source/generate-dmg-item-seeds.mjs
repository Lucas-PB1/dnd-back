...
const txtPath = path.join(__dirname, 'dmg-2024-itens-magicos-az.txt');
const outJson = path.join(__dirname, 'dmg-2024-itens-magicos-az.json');
const outIndex = path.join(__dirname, 'dmg-2024-itens-magicos-az-index.md');
