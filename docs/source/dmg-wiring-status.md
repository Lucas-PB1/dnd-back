...
- Loja (inventário): preços PHB em `S031` (audit Beyond → `docs/source/phb-2024-equipment-prices-audit.md`); parse milhar BR + câmbio na compra; venda = ½ catálogo em campanha (player). Cap. 6 (variantes, montarias, veículos, serviços, pergaminhos 2–9) seedado em `S031` — **rerolar seeds**, sem migrations de patch.
