...
import {
  isHeritageChoiceKind,
  resolveOriginChoicesForSync,
} from '@game/sheet/domain/heritage/origin-choices';
...
export async function syncSkillsAndOrigin(
...
export async function syncOptionsAndFeats(
  deps: CharacterSheetSyncDeps,
  characterId: string,
  input: CharacterSheetInput,
): Promise<void> {
...
export async function syncSpellsEquipmentLanguages(
  deps: CharacterSheetSyncDeps,
  characterId: string,
  input: CharacterSheetInput,
): Promise<void> {
