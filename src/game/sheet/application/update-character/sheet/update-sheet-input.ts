...
export type CharacterIdentityChanges = {
...
export function detectCharacterIdentityChanges(
  dto: UpdateCharacterDto,
  previous: {
    level: number;
    classSlug: string;
...
): CharacterIdentityChanges {
  return {
    levelChanged: dto.level !== undefined && dto.level !== previous.level,
    speciesChanged:
      dto.speciesSlug !== undefined && dto.speciesSlug !== previous.speciesSlug,
    subclassChanged:
      dto.subclassSlug !== undefined &&
      dto.subclassSlug !== previous.subclassSlug,
    classChanged:
      dto.classSlug !== undefined && dto.classSlug !== previous.classSlug,
    backgroundChanged:
      dto.backgroundSlug !== undefined &&
      dto.backgroundSlug !== previous.backgroundSlug,
  };
}
