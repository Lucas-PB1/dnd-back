...
export async function buildCharacterStateResponse(input: {
  ...
  return {
    ...
    wildShapeActive: state.wildShapeActive ?? false,
    wildShapeTemplateSlug: state.wildShapeTemplateSlug ?? null,
    wildShapeKnownSlugs: state.wildShapeKnownSlugs ?? [],
    wildShapeFormSwapAvailable: state.wildShapeFormSwapAvailable ?? true,
